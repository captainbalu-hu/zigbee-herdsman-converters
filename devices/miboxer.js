...
module.exports = [
    {
        ...
        toZigbee: [tz.on_off, tz.tuya_led_control_miboxer, tz.tuya_do_not_disturb, tz.tuya_color_power_on_behavior],
        fromZigbee: [fz.on_off, fz.tuya_led_controller_miboxer, fz.brightness, fz.ignore_basic_report],
